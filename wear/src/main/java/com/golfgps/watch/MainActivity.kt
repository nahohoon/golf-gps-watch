...
class MainActivity : AppCompatActivity() {
    ...
    private fun fetchLocation(isRefresh: Boolean) {
        ...
        setFetching(true)
        setGpsStatus(R.string.gps_refreshing, StatusColor.SEARCHING)
        cancelLocationRequest()
        stopLocationUpdates()
    ...
    companion object {
        ...
        private val GREENS = listOf(
            GreenCenter(1, 35.901921, 128.663646),
            GreenCenter(2, 35.903884, 128.662182),
            GreenCenter(3, 35.900304, 128.661110),
            GreenCenter(4, 35.903393, 128.662044),
            GreenCenter(5, 35.905868, 128.657868),
            GreenCenter(6, 35.904989, 128.656829),
            GreenCenter(7, 35.903172, 128.660513),
            GreenCenter(8, 35.901408, 128.659553),
            GreenCenter(9, 35.899171, 128.661759),
            GreenCenter(10, 35.901561, 128.664029),
            GreenCenter(11, 35.904114, 128.662410),
            GreenCenter(12, 35.900422, 128.660833),
            GreenCenter(13, 35.903402, 128.662336),
            GreenCenter(14, 35.906204, 128.658108),
            GreenCenter(15, 35.905125, 128.656424),
            GreenCenter(16, 35.902787, 128.660486),
            GreenCenter(17, 35.901707, 128.659160),
            GreenCenter(18, 35.899171, 128.661759)
        )
    }
}
